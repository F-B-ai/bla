...
const PRIZE_MILESTONES = [
  {
    threshold: 15,
    icon: '🧘',
    title: 'Mindfulness Personalizzata',
    description: 'Sessione di mindfulness personalizzata in omaggio da Mind Movement Lab',
    color: '#4CAF50',
  },
  {
    threshold: 30,
    ...
    description: 'T-shirt esclusiva Mind Movement Lab in omaggio',
    color: '#2196F3',
  },
  {
    threshold: 40,
    icon: '🤸',
    title: 'Myofascial Release & Mobility',
    description: 'Sessione di Myofascial Release e Mobility (Movimento + Controllo) in omaggio',
    color: '#9C27B0',
  },
  {
    threshold: 50,
    ...
    description: 'Sessione di Personal Training 1-on-1 in omaggio',
    color: '#F44336',
  },
];
